...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left">
              <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
                ...
                <span className="gradient-text block">Planilhas</span>
              ...
              <p className="text-2xl text-slate-300 mb-6 leading-relaxed">
                ...
                <span className="text-white font-semibold"> os padrões que geram lucro</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start">
                <Button 
                  size="lg"
                  onClick={() => setShowRegister(true)}
                  className="gradient-purple-blue hover:opacity-90 transition-all transform hover:scale-105 px-8 py-4 text-lg font-semibold"
                >
                  Começar Grátis
            ...
            <div className="relative">
              {/* Main Dashboard Card */}
              <Card className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl border-slate-700 shadow-2xl transform hover:scale-105 transition-all duration-300">
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-lg font-bold text-white">Dashboard Principal</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Card className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 border-green-500/30">
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm text-slate-300">P&L Total</span>
                          <TrendingUp className="w-4 h-4 text-green-400" />
                        </div>
                        <div className="text-2xl font-bold text-green-400">+R$ 28.540</div>
                        <div className="text-xs text-green-300">+12.4% este mês</div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border-blue-500/30">
                      <CardContent className="p-4">
                        ...
                        <div className="text-xs text-blue-300">156/199 trades</div>
                      </CardContent>
                    </Card>
                  </div>
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full opacity-20 animate-pulse"></div>
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full opacity-20 animate-pulse delay-1000"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Statistics Section */}
      <section className="py-20 bg-gradient-to-r from-purple-900/20 to-blue-900/20 border-y border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">
              Resultados Comprovados
            </h2>
            <p className="text-slate-300">Números reais de traders que transformaram seus resultados</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: "2.1M+", label: "Trades Analisados", icon: Activity },
              { value: "1.200+", label: "Traders Ativos", icon: Users },
              { value: "847%", label: "Média de Melhoria", icon: TrendingUp },
              { value: "4.9/5", label: "Satisfação", icon: Star }
            ].map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="w-16 h-16 gradient-purple-blue rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
      ...
      {/* Pricing Section */}
      <section id="precos" className="py-24 bg-gradient-to-br from-slate-900 via-purple-900/10 to-slate-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="gradient-text block">Perfeito para Você</span>
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Plano Pro - Destaque */}
            <Card className="bg-gradient-to-br from-purple-600/20 to-blue-600/20 border-purple-500 relative transform scale-105 shadow-2xl">
              ...
              <CardContent className="p-8">
                ...
                <Button 
                  className="w-full gradient-purple-blue hover:opacity-90 transition-opacity text-lg font-semibold py-3"
                  onClick={() => setShowRegister(true)}
                >
                  Começar Agora
                  <ArrowRight className="w-5 h-5 ml-2" />
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300">Resultados reais de quem usa o Métrika todos os dias</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border-slate-700">
                <CardContent className="p-8">
      ...
      {/* Final CTA Section */}
      <section className="py-24 bg-gradient-to-br from-purple-900/30 via-slate-900 to-blue-900/30 border-t border-slate-800">
        <div className="max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-slate-700 rounded-3xl p-12 shadow-2xl">
            <h2 className="text-4xl md:text-6xl font-bold mb-8 leading-tight">
              <span className="text-white">Pare de Perder</span>
              <span className="gradient-text block">Dinheiro por Falta</span>
            ...
            <p className="text-2xl text-slate-300 mb-8 max-w-3xl mx-auto">
              ...
              <span className="text-white font-semibold"> Você não precisa ser parte dessa estatística.</span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
              <div className="flex items-center space-x-3 text-slate-300">
                ...
                <span className="text-lg">Setup em 5 minutos</span>
              </div>
              <div className="flex items-center space-x-3 text-slate-300">
                <div className="w-12 h-12 bg-blue-500/20 rounded-full flex items-center justify-center">
                  <Zap className="w-6 h-6 text-blue-400" />
                </div>  
                <span className="text-lg">Resultados imediatos</span>
              </div>
              <div className="flex items-center space-x-3 text-slate-300">
                <div className="w-12 h-12 bg-purple-500/20 rounded-full flex items-center justify-center">
                  <Shield className="w-6 h-6 text-purple-400" />
                </div>
                <span className="text-lg">Garantia 30 dias</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button 
                size="lg"
                onClick={() => setShowRegister(true)}
                className="gradient-purple-blue hover:opacity-90 transition-all transform hover:scale-105 px-12 py-4 text-xl font-bold"
              >
              ...
              <Button 
                size="lg"
                variant="outline"
                className="border-slate-600 text-slate-300 hover:bg-slate-800 px-8 py-4 text-xl"
              >
                Ver Demo Completa
              </Button>
            </div>
            ...
            <div className="text-center">
              <p className="text-slate-400 mb-4">Mais de 1.200 traders já transformaram seus resultados</p>
              <div className="flex items-center justify-center space-x-4">
                ...
                <span className="text-slate-300 font-medium">4.9/5 baseado em 500+ avaliações</span>
              </div>
            </div>
          </div>
        </div>

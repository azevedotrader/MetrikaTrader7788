        ...
        <TabsContent value="consolidated" className="space-y-6">
          ...
          <Card className="bg-zinc-900/90 border-zinc-800">
            <CardHeader>
              ...
              <CardDescription>
                Comparativo de resultados entre as corretoras
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  toast({
                    title: "Dados Atualizados",
                    description:
                      "Dados consolidados de todas as corretoras foram atualizados com sucesso.",
                  });
                }}
              >
                ...
                <AlertDialogContent className="bg-slate-800 border-zinc-800">
                  <AlertDialogHeader>
                    <AlertDialogTitle className="text-white">
                      Resetar Dashboard Completamente
                    </AlertDialogTitle>
                    <AlertDialogDescription className="text-slate-300">
                      Esta ação irá{" "}
                      <strong>deletar TODOS os dados permanentemente</strong>:
                      <br />
                      • Todos os trades de todas as corretoras
                      <br />
                      • Histórico completo de importações CSV
                      <br />
                      • Todas as configurações de API das corretoras
                      <br />
                      <br />
                      Você começará completamente do zero.{" "}

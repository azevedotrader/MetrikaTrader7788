          ...
          <div className="bg-zinc-800 rounded-lg p-4 space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <CheckCircle className={`w-4 h-4 ${planInfo.hasUnlimitedTrades ? 'text-green-500' : 'text-red-500'}`} />
                <span className="text-sm text-zinc-300">
                  {planInfo.hasUnlimitedTrades ? 'Trades ilimitados' : 'Máximo 10 trades'}
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className={`w-4 h-4 ${planInfo.isAiEnabled ? 'text-green-500' : 'text-red-500'}`} />
                <span className="text-sm text-zinc-300">

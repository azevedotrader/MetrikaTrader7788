...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "wallets.subtitle": "Organize seus trades em carteiras personalizadas para melhor análise",
    "wallets.newWallet": "Nova Carteira",
    "wallets.createTitle": "Criar Nova Carteira",
    "wallets.createDescription": "Crie uma carteira personalizada para organizar seus trades",
    "wallets.editTitle": "Editar Carteira",
    "wallets.editDescription": "Atualize as informações da sua carteira",
    "wallets.name": "Nome",
    "wallets.namePlaceholder": "Ex: Prop Firm FTMO, Scalping BTC...",
    "wallets.description": "Descrição (opcional)",
    "wallets.descriptionPlaceholder": "Descreva o propósito desta carteira...",
    "wallets.color": "Cor",
    "wallets.icon": "Ícone",
    "wallets.cancel": "Cancelar",
    "wallets.create": "Criar Carteira",
    "wallets.save": "Salvar Alterações",
    "wallets.edit": "Editar",
    "wallets.delete": "Deletar",
    "wallets.defaultMarkets": "Mercados Padrão",
    "wallets.customWallets": "Suas Carteiras Personalizadas",
    "wallets.noWallets": "Nenhuma carteira criada",
    "wallets.noWalletsDescription": "Crie carteiras personalizadas para organizar seus trades por estratégia, conta ou projeto",
    "wallets.createFirst": "Criar Primeira Carteira",
    "wallets.deleteConfirm": "Tem certeza que deseja deletar a carteira",
    "wallets.created": "Carteira criada!",
    "wallets.createdDescription": "Sua nova carteira está pronta para uso.",
    "wallets.updated": "Carteira atualizada!",
    "wallets.updatedDescription": "As alterações foram salvas.",
    "wallets.deleted": "Carteira deletada",
    "wallets.deletedDescription": "A carteira foi removida com sucesso.",
    "wallets.errorCreate": "Erro ao criar carteira",
    "wallets.errorUpdate": "Erro ao atualizar carteira",
    "wallets.errorDelete": "Erro ao deletar carteira",
    "wallets.nameRequired": "Nome obrigatório",
    "wallets.nameRequiredDescription": "Digite um nome para a carteira.",
    "wallets.tryAgain": "Tente novamente",
    "wallets.cryptoDescription": "Criptomoedas (BTC, ETH, etc)",
    "wallets.forexDescription": "Mercado de câmbio",
    "wallets.b3Description": "Bolsa de valores brasileira",
    "wallets.iconWallet": "Carteira",
    "wallets.iconTrending": "Tendência",
    "wallets.iconCrypto": "Crypto",
    "wallets.iconDollar": "Dólar",
    "wallets.iconChart": "Gráfico",
    "wallets.iconFolder": "Pasta",
    "wallets.colorPurple": "Roxo",
    "wallets.colorBlue": "Azul",
    "wallets.colorGreen": "Verde",
    "wallets.colorYellow": "Amarelo",
    "wallets.colorRed": "Vermelho",
    "wallets.colorPink": "Rosa",
    "wallets.colorIndigo": "Índigo",
    "wallets.colorCyan": "Ciano",
    ...
    "landing.pricing.monthly_title": "Mensal",
    "landing.pricing.monthly_price": "R$ 97",
    "landing.pricing.monthly_period": "/mês",
    "landing.pricing.monthly_feature1": "Trades ilimitados",
    "landing.pricing.monthly_feature2": "Análise com IA avançada",
    "landing.pricing.monthly_feature3": "Importação CSV ilimitada",
    "landing.pricing.monthly_feature4": "Suporte prioritário",
    "landing.pricing.monthly_button": "Assinar Mensal",
    "landing.pricing.quarterly_title": "Trimestral",
    "landing.pricing.quarterly_price": "R$ 197",
    "landing.pricing.quarterly_period": "/trimestre",
    "landing.pricing.quarterly_savings": "Economize 32%",
    "landing.pricing.quarterly_feature1": "Tudo do Mensal +",
    "landing.pricing.quarterly_feature2": "3 meses de acesso",
    "landing.pricing.quarterly_feature3": "Melhor custo-benefício",
    "landing.pricing.quarterly_feature4": "Relatórios avançados",
    "landing.pricing.quarterly_button": "Assinar Trimestral",
    "landing.pricing.annual_title": "Anual",
    "landing.pricing.annual_price": "R$ 547",
    "landing.pricing.annual_period": "/ano",
    "landing.pricing.annual_savings": "Economize 53%",
    "landing.pricing.annual_feature1": "Tudo do Trimestral +",
    "landing.pricing.annual_feature2": "12 meses de acesso",
    "landing.pricing.annual_feature3": "IA treinada no seu histórico",
    "landing.pricing.annual_feature4": "Suporte VIP dedicado",
    "landing.pricing.annual_feature5": "Gestão de risco personalizada",
    "landing.pricing.annual_feature6": "Acesso completo a todos os recursos",
    "landing.pricing.annual_button": "Assinar Anual",
  ...
  en: {
    ...
    "wallets.subtitle": "Organize your trades in custom wallets for better analysis",
    "wallets.newWallet": "New Wallet",
    "wallets.createTitle": "Create New Wallet",
    "wallets.createDescription": "Create a custom wallet to organize your trades",
    "wallets.editTitle": "Edit Wallet",
    "wallets.editDescription": "Update your wallet information",
    "wallets.name": "Name",
    "wallets.namePlaceholder": "Ex: Prop Firm FTMO, Scalping BTC...",
    "wallets.description": "Description (optional)",
    "wallets.descriptionPlaceholder": "Describe the purpose of this wallet...",
    "wallets.color": "Color",
    "wallets.icon": "Icon",
    "wallets.cancel": "Cancel",
    "wallets.create": "Create Wallet",
    "wallets.save": "Save Changes",
    "wallets.edit": "Edit",
    "wallets.delete": "Delete",
    "wallets.defaultMarkets": "Default Markets",
    "wallets.customWallets": "Your Custom Wallets",
    "wallets.noWallets": "No wallets created",
    "wallets.noWalletsDescription": "Create custom wallets to organize your trades by strategy, account or project",
    "wallets.createFirst": "Create First Wallet",
    "wallets.deleteConfirm": "Are you sure you want to delete the wallet",
    "wallets.created": "Wallet created!",
    "wallets.createdDescription": "Your new wallet is ready to use.",
    "wallets.updated": "Wallet updated!",
    "wallets.updatedDescription": "Changes have been saved.",
    "wallets.deleted": "Wallet deleted",
    "wallets.deletedDescription": "The wallet has been successfully removed.",
    "wallets.errorCreate": "Error creating wallet",
    "wallets.errorUpdate": "Error updating wallet",
    "wallets.errorDelete": "Error deleting wallet",
    "wallets.nameRequired": "Name required",
    "wallets.nameRequiredDescription": "Enter a name for the wallet.",
    "wallets.tryAgain": "Try again",
    "wallets.cryptoDescription": "Cryptocurrencies (BTC, ETH, etc)",
    "wallets.forexDescription": "Foreign exchange market",
    "wallets.b3Description": "Brazilian stock exchange",
    "wallets.iconWallet": "Wallet",
    "wallets.iconTrending": "Trending",
    "wallets.iconCrypto": "Crypto",
    "wallets.iconDollar": "Dollar",
    "wallets.iconChart": "Chart",
    "wallets.iconFolder": "Folder",
    "wallets.colorPurple": "Purple",
    "wallets.colorBlue": "Blue",
    "wallets.colorGreen": "Green",
    "wallets.colorYellow": "Yellow",
    "wallets.colorRed": "Red",
    "wallets.colorPink": "Pink",
    "wallets.colorIndigo": "Indigo",
    "wallets.colorCyan": "Cyan",
    ...
    "landing.pricing.monthly_title": "Monthly",
    "landing.pricing.monthly_price": "R$ 97",
    "landing.pricing.monthly_period": "/month",
    "landing.pricing.monthly_feature1": "Unlimited trades",
    "landing.pricing.monthly_feature2": "Advanced AI analysis",
    "landing.pricing.monthly_feature3": "Unlimited CSV import",
    "landing.pricing.monthly_feature4": "Priority support",
    "landing.pricing.monthly_button": "Subscribe Monthly",
    "landing.pricing.quarterly_title": "Quarterly",
    "landing.pricing.quarterly_price": "R$ 197",
    "landing.pricing.quarterly_period": "/quarter",
    "landing.pricing.quarterly_savings": "Save 32%",
    "landing.pricing.quarterly_feature1": "Everything in Monthly +",
    "landing.pricing.quarterly_feature2": "3 months access",
    "landing.pricing.quarterly_feature3": "Best value",
    "landing.pricing.quarterly_feature4": "Advanced reports",
    "landing.pricing.quarterly_button": "Subscribe Quarterly",
    "landing.pricing.annual_title": "Annual",
    "landing.pricing.annual_price": "R$ 547",
    "landing.pricing.annual_period": "/year",
    "landing.pricing.annual_savings": "Save 53%",
    "landing.pricing.annual_feature1": "Everything in Quarterly +",
    "landing.pricing.annual_feature2": "12 months access",
    "landing.pricing.annual_feature3": "AI trained on your history",
    "landing.pricing.annual_feature4": "Dedicated VIP support",
    "landing.pricing.annual_feature5": "Personalized risk management",
    "landing.pricing.annual_feature6": "Full access to all features",
    "landing.pricing.annual_button": "Subscribe Annual",
  ...
  es: {
    ...
    "wallets.subtitle": "Organiza tus operaciones en carteras personalizadas para un mejor análisis",
    "wallets.newWallet": "Nueva Cartera",
    "wallets.createTitle": "Crear Nueva Cartera",
    "wallets.createDescription": "Crea una cartera personalizada para organizar tus operaciones",
    "wallets.editTitle": "Editar Cartera",
    "wallets.editDescription": "Actualiza la información de tu cartera",
    "wallets.name": "Nombre",
    "wallets.namePlaceholder": "Ej: Prop Firm FTMO, Scalping BTC...",
    "wallets.description": "Descripción (opcional)",
    "wallets.descriptionPlaceholder": "Describe el propósito de esta cartera...",
    "wallets.color": "Color",
    "wallets.icon": "Ícono",
    "wallets.cancel": "Cancelar",
    "wallets.create": "Crear Cartera",
    "wallets.save": "Guardar Cambios",
    "wallets.edit": "Editar",
    "wallets.delete": "Eliminar",
    "wallets.defaultMarkets": "Mercados Predeterminados",
    "wallets.customWallets": "Tus Carteras Personalizadas",
    "wallets.noWallets": "No hay carteras creadas",
    "wallets.noWalletsDescription": "Crea carteras personalizadas para organizar tus operaciones por estrategia, cuenta o proyecto",
    "wallets.createFirst": "Crear Primera Cartera",
    "wallets.deleteConfirm": "¿Estás seguro de que deseas eliminar la cartera",
    "wallets.created": "¡Cartera creada!",
    "wallets.createdDescription": "Tu nueva cartera está lista para usar.",
    "wallets.updated": "¡Cartera actualizada!",
    "wallets.updatedDescription": "Los cambios han sido guardados.",
    "wallets.deleted": "Cartera eliminada",
    "wallets.deletedDescription": "La cartera ha sido eliminada exitosamente.",
    "wallets.errorCreate": "Error al crear cartera",
    "wallets.errorUpdate": "Error al actualizar cartera",
    "wallets.errorDelete": "Error al eliminar cartera",
    "wallets.nameRequired": "Nombre requerido",
    "wallets.nameRequiredDescription": "Ingresa un nombre para la cartera.",
    "wallets.tryAgain": "Intenta de nuevo",
    "wallets.cryptoDescription": "Criptomonedas (BTC, ETH, etc)",
    "wallets.forexDescription": "Mercado de divisas",
    "wallets.b3Description": "Bolsa de valores brasileña",
    "wallets.iconWallet": "Cartera",
    "wallets.iconTrending": "Tendencia",
    "wallets.iconCrypto": "Crypto",
    "wallets.iconDollar": "Dólar",
    "wallets.iconChart": "Gráfico",
    "wallets.iconFolder": "Carpeta",
    "wallets.colorPurple": "Morado",
    "wallets.colorBlue": "Azul",
    "wallets.colorGreen": "Verde",
    "wallets.colorYellow": "Amarillo",
    "wallets.colorRed": "Rojo",
    "wallets.colorPink": "Rosa",
    "wallets.colorIndigo": "Índigo",
    "wallets.colorCyan": "Cian",
    ...
    "landing.pricing.monthly_title": "Mensual",
    "landing.pricing.monthly_price": "R$ 97",
    "landing.pricing.monthly_period": "/mes",
    "landing.pricing.monthly_feature1": "Operaciones ilimitadas",
    "landing.pricing.monthly_feature2": "Análisis con IA avanzada",
    "landing.pricing.monthly_feature3": "Importación CSV ilimitada",
    "landing.pricing.monthly_feature4": "Soporte prioritario",
    "landing.pricing.monthly_button": "Suscribir Mensual",
    "landing.pricing.quarterly_title": "Trimestral",
    "landing.pricing.quarterly_price": "R$ 197",
    "landing.pricing.quarterly_period": "/trimestre",
    "landing.pricing.quarterly_savings": "Ahorra 32%",
    "landing.pricing.quarterly_feature1": "Todo en Mensual +",
    "landing.pricing.quarterly_feature2": "3 meses de acceso",
    "landing.pricing.quarterly_feature3": "Mejor valor",
    "landing.pricing.quarterly_feature4": "Informes avanzados",
    "landing.pricing.quarterly_button": "Suscribir Trimestral",
    "landing.pricing.annual_title": "Anual",
    "landing.pricing.annual_price": "R$ 547",
    "landing.pricing.annual_period": "/año",
    "landing.pricing.annual_savings": "Ahorra 53%",
    "landing.pricing.annual_feature1": "Todo en Trimestral +",
    "landing.pricing.annual_feature2": "12 meses de acceso",
    "landing.pricing.annual_feature3": "IA entrenada en tu historial",
    "landing.pricing.annual_feature4": "Soporte VIP dedicado",
    "landing.pricing.annual_feature5": "Gestión de riesgo personalizada",
    "landing.pricing.annual_feature6": "Acceso completo a todas las funciones",
    "landing.pricing.annual_button": "Suscribir Anual",

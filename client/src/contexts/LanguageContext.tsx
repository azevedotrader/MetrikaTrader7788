...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "metrics.advanced_metrics": "Métricas Avançadas",
    "metrics.progress_tracker": "Rastreador de Progresso",
    "metrics.daily_net_pnl": "PnL Líquido Diário",
    "metrics.iqt": "IQT",
    "metrics.efficiency": "Eficiência",
    "metrics.rap": "RAP",
    "metrics.ipi": "IPI",
    "metrics.expectancy": "Expectancy",
    "metrics.metrika_score": "Gráfico de Consistência",
    "metrics.profits_short": "Lucros",
    "metrics.losses_short": "Perdas",
    "metrics.average": "Média",
    "metrics.per_trade": "por trade",
    "metrics.trade_time_performance": "Performance Temporal de Trades",
    "metrics.drawdown": "Drawdown",
    "metrics.quality_index": "Índice Qualidade",
    "metrics.risk_percentage": "Risco %",
    "metrics.score": "Score",
    "metrics.precision": "Precisão",
    "metrics.performance": "Performance",
    "metrics.van_tharp": "Van Tharp",
    ...
    "landing.pricing.black_title": "Trader VIP",
  ...
  en: {
    ...
    "metrics.advanced_metrics": "Advanced Metrics",
    "metrics.iqt": "IQT",
    "metrics.efficiency": "Efficiency",
    "metrics.rap": "RAP",
    "metrics.ipi": "IPI",
    "metrics.expectancy": "Expectancy",
    "metrics.metrika_score": "Consistency Chart",
    "metrics.profits_short": "Profits",
    "metrics.losses_short": "Losses",
    "metrics.average": "Average",
    "metrics.per_trade": "per trade",
    "metrics.trade_time_performance": "Trade Time Performance",
    "metrics.drawdown": "Drawdown",
    "metrics.quality_index": "Quality Index",
    "metrics.risk_percentage": "Risk %",
    "metrics.score": "Score",

...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    'support.description': 'Entre em contato conosco para obter ajuda com sua conta',
    ...
    'support.message_placeholder': 'Descreva detalhadamente sua dúvida ou problema...',
    ...
    'journal.start_recording': 'Comece registrando suas reflexões e análises de trading',
    ...
    'journal.session_placeholder': 'Descreva como foi sua sessão de trading hoje...',
    ...
    'journal.improvements_placeholder': 'O que você pode melhorar na próxima sessão?',
    ...
    'journal.toast.created_desc': 'Sua entrada do diário foi criada com sucesso.',
    'journal.toast.updated': 'Entrada atualizada!',
    'journal.toast.updated_desc': 'Sua entrada do diário foi atualizada com sucesso.',
    'journal.toast.deleted': 'Entrada deletada!',
    'journal.toast.deleted_desc': 'Sua entrada do diário foi deletada com sucesso.',
    'journal.toast.error_save': 'Erro ao salvar',
    'journal.toast.error_save_desc': 'Não foi possível salvar a entrada. Tente novamente.',
    'journal.toast.error_delete': 'Erro ao deletar',
    'journal.toast.error_delete_desc': 'Não foi possível deletar a entrada. Tente novamente.',
    ...
    'landing.hero.announcement': '✨ Novo: Integração com Gate.io + 3 Corretoras',
    ...
    'landing.problem.subtitle': 'Sem dados precisos e análises consistentes, você está operando no escuro. Métrika revela exatamente onde você perde dinheiro e como corrigir.',
    'landing.problem.outdated_sheets': 'Planilhas Desatualizadas',
    'landing.problem.outdated_sheets_desc': 'Você perde tempo preenchendo planilhas manualmente em vez de focar nas operações',
    'landing.problem.imprecise_data': 'Dados Imprecisos',
    'landing.problem.imprecise_data_desc': 'Erros de cálculo e dados inconsistentes levam a decisões erradas',
    'landing.problem.limited_analysis': 'Análise Limitada',
    'landing.problem.limited_analysis_desc': 'Sem insights profundos sobre seus padrões de trading, você repete os mesmos erros',
    ...
    'landing.solution.subtitle': 'Veja exatamente como o Métrika transforma seus dados de trading em insights acionáveis',
    ...
    'landing.solution.auto_import_desc': 'Conecte suas corretoras e tenha todos os trades importados automaticamente. Zero trabalho manual.',
    'landing.solution.ai_analytics': 'IA Analytics',
    'landing.solution.ai_analytics_desc': 'Algoritmos avançados identificam seus padrões de lucro e perda, revelando insights invisíveis.',
    'landing.solution.risk_management': 'Risk Management',
    'landing.solution.risk_management_desc': 'Monitore seu risco em tempo real e receba alertas antes de comprometer seu capital.',
    'landing.solution.smart_journal': 'Journal Inteligente',
    'landing.solution.smart_journal_desc': 'Sistema de journaling que aprende com seus trades e sugere melhorias automáticas.',
    
    // Landing Page - Statistics
    'landing.stats.title': 'Resultados Comprovados',
    'landing.stats.subtitle': 'Números reais de traders que transformaram seus resultados',
    ...
    'landing.pricing.subtitle': 'Transforme sua análise de trading hoje mesmo. Cancele quando quiser.',
    ...
    'landing.pricing.starter_feature1': 'Acesso completo às métricas dos seus trades',
    ...
    'landing.pricing.starter_feature4': 'Filtros avançados por mercado e período',
    ...
    'landing.testimonials.subtitle': 'Resultados reais de quem usa o Métrika todos os dias',
    'landing.testimonials.carlos_name': 'Carlos Rodrigues',
    'landing.testimonials.carlos_role': 'Day Trader • São Paulo',
    'landing.testimonials.carlos_content': 'Métrika me fez economizar 4 horas por semana que eu gastava com planilhas. Agora posso focar 100% no trading. Meu win rate subiu de 62% para 78%.',
    ...
    'landing.testimonials.ana_content': 'A integração com Gate.io foi um divisor de águas. Todos os meus trades crypto são importados automaticamente. O analytics revelou padrões que eu nunca tinha notado.',
    ...
    'landing.testimonials.pedro_content': 'Testei várias plataformas de journaling, mas nenhuma chega perto do Métrika. O sistema de IA realmente aprende com meus trades e me dá insights valiosos.',
    ...
    'landing.features.subtitle': 'Cada função foi pensada para acelerar seu progresso e maximizar seus lucros',
    'landing.features.auto_sync': 'Sync Automático',
    'landing.features.auto_sync_desc': 'Importe seus trades e tenha controle sobre cada mercado com todas métricas de visualização organizada.',
    'landing.features.ai_analytics': 'IA Analytics',
    'landing.features.ai_analytics_desc': 'Integração com inteligência artificial para estudar as métricas da sua conta detalhada mostrando as melhores correções e ajustes para potencializar resultados.',
    'landing.features.risk_manager': 'Risk Manager',
    'landing.features.risk_manager_desc': 'Monitore risco em tempo real e receba alertas antes de comprometer capital.',
    'landing.features.smart_journal': 'Journal Inteligente',
    'landing.features.smart_journal_desc': 'Sistema aprende com seus trades e sugere melhorias automaticamente.',
    'landing.features.advanced_charts': 'Charts Avançados',
    'landing.features.advanced_charts_desc': 'Visualizações interativas que revelam padrões ocultos nos seus dados.',
    'landing.features.time_analytics': 'Time Analytics',
    'landing.features.time_analytics_desc': 'Descubra seus ativos, horários e dias mais lucrativos com uma análise de dados eficiente e organizada.',
    'landing.features.multi_asset': 'Multi-Asset',
    'landing.features.multi_asset_desc': 'Forex, Crypto, Ações, Futuros - todos os mercados em uma plataforma.',
    'landing.features.complete_export': 'Export Completo',
    'landing.features.complete_export_desc': 'Exporte relatórios profissionais em PDF para clientes e investidores.',
    
    // Landing Page - Final CTA
    'landing.cta.title1': 'Pare de Perder',
    'landing.cta.title2': 'Dinheiro por Falta',
    'landing.cta.title3': 'de Dados',
    'landing.cta.subtitle1': '95% dos traders falham porque não sabem o que estão fazendo errado.',
    ...
    'landing.cta.social_proof': 'Mais de 1.200 traders já transformaram seus resultados',
    'landing.cta.rating': '4.9/5 baseado em 500+ avaliações',
    
    // Landing Page - Footer
    'landing.footer.description': 'A plataforma de analytics de trading mais avançada do Brasil. Transforme seus dados em lucro com inteligência artificial.',
    ...
    'landing.footer.copyright': '© 2025 Métrika. Todos os direitos reservados.',
    'landing.footer.made_with_love': 'Desenvolvido com ❤️ para traders brasileiros.',
    ...
    'register.success_description': 'Agora você pode fazer login com suas credenciais.',
  ...
  en: {
    ...
    'support.message_placeholder': 'Describe your question or problem in detail...',
    ...
    'journal.start_recording': 'Start recording your trading thoughts and analysis',
    ...
    'journal.session_placeholder': 'Describe how your trading session went today...',
    ...
    'journal.improvements_placeholder': 'What can you improve in the next session?',
    ...
    'journal.toast.error_save_desc': 'Could not save the entry. Please try again.',
    'journal.toast.error_delete': 'Error deleting',
    'journal.toast.error_delete_desc': 'Could not delete the entry. Please try again.',
    ...
    'landing.problem.subtitle': 'Without accurate data and consistent analysis, you\'re trading in the dark. Métrika reveals exactly where you lose money and how to fix it.',
    'landing.problem.outdated_sheets': 'Outdated Spreadsheets',
    'landing.problem.outdated_sheets_desc': 'You waste time filling spreadsheets manually instead of focusing on trades',
    'landing.problem.imprecise_data': 'Imprecise Data',
    'landing.problem.imprecise_data_desc': 'Calculation errors and inconsistent data lead to wrong decisions',
    'landing.problem.limited_analysis': 'Limited Analysis',
    'landing.problem.limited_analysis_desc': 'Without deep insights into your trading patterns, you repeat the same mistakes',
    ...
    'landing.solution.subtitle': 'See exactly how Métrika transforms your trading data into actionable insights',
    'landing.solution.dashboard_analytics': 'Dashboard Analytics',
    'landing.solution.realtime': 'Real-time',
    ...
    'landing.solution.auto_import_desc': 'Connect your brokers and have all trades imported automatically. Zero manual work.',
    'landing.solution.ai_analytics': 'AI Analytics',
    'landing.solution.ai_analytics_desc': 'Advanced algorithms identify your profit and loss patterns, revealing invisible insights.',
    'landing.solution.risk_management': 'Risk Management',
    'landing.solution.risk_management_desc': 'Monitor your risk in real-time and receive alerts before compromising your capital.',
    'landing.solution.smart_journal': 'Smart Journal',
    'landing.solution.smart_journal_desc': 'Journaling system that learns from your trades and suggests automatic improvements.',
    
    // Landing Page - Statistics
    'landing.stats.title': 'Proven Results',
    'landing.stats.subtitle': 'Real numbers from traders who transformed their results',
    ...
    'landing.pricing.subtitle': 'Transform your trading analysis today. Cancel anytime.',
    'landing.pricing.starter_title': 'Trader Starter',
    ...
    'landing.testimonials.subtitle': 'Real results from those who use Métrika every day',
    'landing.testimonials.carlos_name': 'Carlos Rodrigues',
    'landing.testimonials.carlos_role': 'Day Trader • São Paulo',
    'landing.testimonials.carlos_content': 'Métrika saved me 4 hours per week that I spent on spreadsheets. Now I can focus 100% on trading. My win rate went from 62% to 78%.',
    'landing.testimonials.carlos_improvement': '+$15,600 in 3 months',
    'landing.testimonials.ana_name': 'Ana Silva',
    'landing.testimonials.ana_role': 'Swing Trader • Rio de Janeiro',
    'landing.testimonials.ana_content': 'The Gate.io integration was a game changer. All my crypto trades are imported automatically. Analytics revealed patterns I had never noticed.',
    'landing.testimonials.ana_improvement': 'Win rate: 65% → 81%',
    'landing.testimonials.pedro_name': 'Pedro Santos',
    'landing.testimonials.pedro_role': 'Forex Trader • Belo Horizonte',
    'landing.testimonials.pedro_content': 'I tested several journaling platforms, but none come close to Métrika. The AI system really learns from my trades and gives me valuable insights.',
    ...
    'landing.features.subtitle': 'Each function was designed to accelerate your progress and maximize your profits',
    'landing.features.auto_sync': 'Auto Sync',
    'landing.features.auto_sync_desc': 'Import your trades and have control over each market with all organized visualization metrics.',
    'landing.features.ai_analytics': 'AI Analytics',
    'landing.features.ai_analytics_desc': 'Artificial intelligence integration to study your account metrics in detail showing the best corrections and adjustments to boost results.',
    'landing.features.risk_manager': 'Risk Manager',
    'landing.features.risk_manager_desc': 'Monitor risk in real-time and receive alerts before compromising capital.',
    'landing.features.smart_journal': 'Smart Journal',
    'landing.features.smart_journal_desc': 'System learns from your trades and suggests improvements automatically.',
    'landing.features.advanced_charts': 'Advanced Charts',
    'landing.features.advanced_charts_desc': 'Interactive visualizations that reveal hidden patterns in your data.',
    'landing.features.time_analytics': 'Time Analytics',
    'landing.features.time_analytics_desc': 'Discover your most profitable assets, times and days with efficient and organized data analysis.',
    'landing.features.multi_asset': 'Multi-Asset',
    'landing.features.multi_asset_desc': 'Forex, Crypto, Stocks, Futures - all markets in one platform.',
    'landing.features.complete_export': 'Complete Export',
    'landing.features.complete_export_desc': 'Export professional PDF reports for clients and investors.',
    
    // Landing Page - Final CTA
    'landing.cta.title1': 'Stop Losing',
    'landing.cta.title2': 'Money for Lack',
    'landing.cta.title3': 'of Data',
    'landing.cta.subtitle1': '95% of traders fail because they don\'t know what they\'re doing wrong.',
    ...
    'landing.cta.social_proof': 'Over 1,200 traders have already transformed their results',
    'landing.cta.rating': '4.9/5 based on 500+ reviews',
    
    // Landing Page - Footer
    'landing.footer.description': 'Brazil\'s most advanced trading analytics platform. Transform your data into profit with artificial intelligence.',
  ...
  es: {
    ...
    'support.message_placeholder': 'Describe tu pregunta o problema en detalle...',
    ...
    'support.no_conversations_desc': 'Haz clic en "Nueva Conversación" para empezar',
    ...
    'journal.start_recording': 'Comienza registrando tus reflexiones y análisis de trading',
    ...
    'journal.session_placeholder': 'Describe cómo fue tu sesión de trading hoy...',
    'journal.emotional_state': 'Estado Emocional',
    ...
    'journal.improvements_placeholder': '¿Qué puedes mejorar en la próxima sesión?',
    'journal.saving': 'Guardando...',
    'journal.update': 'Actualizar',
    'journal.delete_confirm': '¿Estás seguro de que quieres eliminar esta entrada?',
    ...
    'journal.toast.updated_desc': 'Tu entrada del diario se actualizó con éxito.',
    ...
    'journal.toast.error_save_desc': 'No se pudo guardar la entrada. Inténtalo de nuevo.',
    'journal.toast.error_delete': 'Error al eliminar',
    'journal.toast.error_delete_desc': 'No se pudo eliminar la entrada. Inténtalo de nuevo.',
    ...
    // Landing Page - Hero Section
    'landing.hero.announcement': '✨ Nuevo: Integración con Gate.io + 3 Brokers',
    ...
    'landing.problem.subtitle': 'Sin datos precisos y análisis consistentes, estás operando a ciegas. Métrika revela exactamente dónde pierdes dinero y cómo corregirlo.',
    'landing.problem.outdated_sheets': 'Hojas de Cálculo Desactualizadas',
    'landing.problem.outdated_sheets_desc': 'Pierdes tiempo llenando hojas de cálculo manualmente en lugar de enfocarte en las operaciones',
    'landing.problem.imprecise_data': 'Datos Imprecisos',
    'landing.problem.imprecise_data_desc': 'Errores de cálculo y datos inconsistentes llevan a decisiones erróneas',
    'landing.problem.limited_analysis': 'Análisis Limitado',
    'landing.problem.limited_analysis_desc': 'Sin insights profundos sobre tus patrones de trading, repites los mismos errores',
    ...
    'landing.solution.subtitle': 'Ve exactamente cómo Métrika transforma tus datos de trading en insights accionables',
    ...
    'landing.solution.auto_import_desc': 'Conecta tus brokers y ten todas las operaciones importadas automáticamente. Cero trabajo manual.',
    'landing.solution.ai_analytics': 'IA Analytics',
    'landing.solution.ai_analytics_desc': 'Algoritmos avanzados identifican tus patrones de ganancia y pérdida, revelando insights invisibles.',
    'landing.solution.risk_management': 'Gestión de Riesgo',
    'landing.solution.risk_management_desc': 'Monitorea tu riesgo en tiempo real y recibe alertas antes de comprometer tu capital.',
    'landing.solution.smart_journal': 'Diario Inteligente',
    'landing.solution.smart_journal_desc': 'Sistema de diario que aprende de tus operaciones y sugiere mejoras automáticas.',
    
    // Landing Page - Statistics
    'landing.stats.title': 'Resultados Comprobados',
    'landing.stats.subtitle': 'Números reales de traders que transformaron sus resultados',
    ...
    'landing.pricing.subtitle': 'Transforma tu análisis de trading hoy mismo. Cancela cuando quieras.',
    'landing.pricing.starter_title': 'Trader Starter',
    'landing.pricing.starter_price': '$19.99',
    'landing.pricing.starter_period': '/mes',
    'landing.pricing.starter_trial': '7 días gratis',
    'landing.pricing.starter_feature1': 'Acceso completo a las métricas de tus operaciones',
    ...
    'landing.pricing.starter_feature4': 'Filtros avanzados por mercado y período',
    ...
    'landing.testimonials.subtitle': 'Resultados reales de quienes usan Métrika todos los días',
    'landing.testimonials.carlos_name': 'Carlos Rodrigues',
    'landing.testimonials.carlos_role': 'Day Trader • São Paulo',
    'landing.testimonials.carlos_content': 'Métrika me ahorró 4 horas por semana que gastaba en hojas de cálculo. Ahora puedo enfocarme 100% en el trading. Mi tasa de acierto subió del 62% al 78%.',
    'landing.testimonials.carlos_improvement': '+$15.600 en 3 meses',
    'landing.testimonials.ana_name': 'Ana Silva',
    'landing.testimonials.ana_role': 'Swing Trader • Rio de Janeiro',
    'landing.testimonials.ana_content': 'La integración con Gate.io fue un cambio de juego. Todas mis operaciones crypto se importan automáticamente. El analytics reveló patrones que nunca había notado.',
    'landing.testimonials.ana_improvement': 'Tasa de acierto: 65% → 81%',
    'landing.testimonials.pedro_name': 'Pedro Santos',
    'landing.testimonials.pedro_role': 'Forex Trader • Belo Horizonte',
    'landing.testimonials.pedro_content': 'Probé varias plataformas de diario, pero ninguna se acerca a Métrika. El sistema de IA realmente aprende de mis operaciones y me da insights valiosos.',
    'landing.testimonials.pedro_improvement': 'Capital creció 340%',
    
    // Landing Page - Features Grid
    'landing.features.title1': 'Recursos Exclusivos',
    'landing.features.title2': 'que Marcan la Diferencia',
    'landing.features.subtitle': 'Cada función fue diseñada para acelerar tu progreso y maximizar tus ganancias',
    'landing.features.auto_sync': 'Sincronización Automática',
    'landing.features.auto_sync_desc': 'Importa tus operaciones y ten control sobre cada mercado con todas las métricas de visualización organizadas.',
    'landing.features.ai_analytics': 'IA Analytics',
    'landing.features.ai_analytics_desc': 'Integración con inteligencia artificial para estudiar las métricas de tu cuenta detalladamente mostrando las mejores correcciones y ajustes para potenciar resultados.',
    'landing.features.risk_manager': 'Gestor de Riesgo',
    'landing.features.risk_manager_desc': 'Monitorea el riesgo en tiempo real y recibe alertas antes de comprometer el capital.',
    'landing.features.smart_journal': 'Diario Inteligente',
    'landing.features.smart_journal_desc': 'El sistema aprende de tus operaciones y sugiere mejoras automáticamente.',
    'landing.features.advanced_charts': 'Gráficos Avanzados',
    'landing.features.advanced_charts_desc': 'Visualizaciones interactivas que revelan patrones ocultos en tus datos.',
    'landing.features.time_analytics': 'Análisis Temporal',
    'landing.features.time_analytics_desc': 'Descubre tus activos, horarios y días más rentables con un análisis de datos eficiente y organizado.',
    'landing.features.multi_asset': 'Multi-Activo',
    'landing.features.multi_asset_desc': 'Forex, Crypto, Acciones, Futuros - todos los mercados en una plataforma.',
    'landing.features.complete_export': 'Exportación Completa',
    'landing.features.complete_export_desc': 'Exporta reportes profesionales en PDF para clientes e inversores.',
    
    // Landing Page - Final CTA
    'landing.cta.title1': 'Deja de Perder',
    'landing.cta.title2': 'Dinero por Falta',
    'landing.cta.title3': 'de Datos',
    'landing.cta.subtitle1': '95% de los traders fallan porque no saben qué están haciendo mal.',
    ...
    'landing.cta.demo_button': 'Ver Demo Completa',
    'landing.cta.social_proof': 'Más de 1.200 traders ya transformaron sus resultados',
    'landing.cta.rating': '4.9/5 basado en 500+ evaluaciones',
    
    // Landing Page - Footer
    'landing.footer.description': 'La plataforma de analytics de trading más avanzada de Brasil. Transforma tus datos en ganancias con inteligencia artificial.',
    ...
    'landing.footer.copyright': '© 2025 Métrika. Todos los derechos reservados.',
    'landing.footer.made_with_love': 'Desarrollado con ❤️ para traders brasileros.',
    ...
    'register.success_description': 'Ahora puedes iniciar sesión con tus credenciales.',

...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    "risk_management.conservative_desc": "Conservative: Always maintain 1% per operation to preserve capital long term.",
    "risk_management.moderate_desc": "Moderate: Use 2-3% per operation, balancing growth and safety.",
    "risk_management.high_risk_desc": "High Risk: Up to 5% per operation for experienced traders with high risk tolerance.",
  ...
  es: {
    ...
    "risk_management.conservative_desc": "Conservador: Mantén siempre 1% por operación para preservar capital a largo plazo.",
    "risk_management.moderate_desc": "Moderado: Usa 2-3% por operación, equilibrando crecimiento y seguridad.",
    "risk_management.high_risk_desc": "Alto Riesgo: Hasta 5% por operación para traders experimentados con alta tolerancia al riesgo.",
